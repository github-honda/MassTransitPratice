...
○ 安裝 RabbitMQ Docker
請參考 https://github.com/github-honda/MassTransitPratice/blob/main/ReadmeMassTransit.txt 之 #### 安裝 MassTransit1 RabbitMQ Docker.
...
○ scatter/gather
原始碼, SetUpExchangeAndQueuesForScatterGatherDemo
https://github.com/github-honda/MassTransitPratice/tree/main/Net48/2016Lab/V2016/VOriginal/Service1
原始碼, ScatterGatherSender
https://github.com/github-honda/MassTransitPratice/tree/main/Net48/2016Lab/V2016/VOriginal/Publisher8
原始碼, ScatterGatherReceiverOne, ScatterGatherReceiverTwo, ScatterGatherReceiverThree
https://github.com/github-honda/MassTransitPratice/tree/main/Net48/2016Lab/V2016/VOriginal/Consumer8A
https://github.com/github-honda/MassTransitPratice/tree/main/Net48/2016Lab/V2016/VOriginal/Consumer8B
https://github.com/github-honda/MassTransitPratice/tree/main/Net48/2016Lab/V2016/VOriginal/Consumer8C

□ RabbitMQ in .NET C#: basic error handling in Receiver
簡單的說, 就是接收端回應放棄或重試:
Reject the message and discard completely
  model.BasicReject(deliveryArguments.DeliveryTag, false); // 放棄.
Reject the message but push back to queue for later re-try
  model.BasicReject(deliveryArguments.DeliveryTag, true);  // 重試.
...
或者也可以控制重試次數上限, 重試次數可以透過回應訊息時, 寫入 Headers 屬性中, 存回 RabbitMQ:
